...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                            KC_N     , KC_M     , KC_BTN1  , KC_BTN2   , KC_BSPC  ,
    _______  , KC_LALT  , KC_LGUI  , LCTL_T(KC_ESC),LT(2,KC_LNG2), LSFT_T(KC_SPACE), LSFT_T(KC_SPACE), LT(2,KC_LNG1),LT(1,KC_LNG2),KC_RALT,KC_RGUI, KC_RSFT
  ),
